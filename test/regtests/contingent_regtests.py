...
from dcf import pv, CashFlowList, OptionPricingCurve, OptionCashFlowPayOff
...
class ContingentCashFlowRegTests(RegressionTestCase):
    ...
    def test_option_cashflow_list(self):
        model = OptionPricingCurve.black76(**self.kwargs)
    ...
    def test_contingent_rate_cashflow_list(self):
        ...
        model = OptionPricingCurve.bachelier(**self.kwargs)
